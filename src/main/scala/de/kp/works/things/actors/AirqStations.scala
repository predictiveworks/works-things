...
class AirqStations extends BaseActor {
  ...
  override def execute(request: HttpRequest): String = {
    ...
    val req = mapper.readValue(json.toString, classOf[AirqStationsReq])
    ...
    /*
     * This request retrieves the pre-defined air quality stations
     * (see configuration file)
     */
    val stations = AirqOptions.getStations
